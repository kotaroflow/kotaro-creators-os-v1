...
export const getRankTheme = (rawRank: string, isDarkMode: boolean) => {
  ...
  const themes: Record<string, any> = {
    ...
    'E': {
      ...
      glow: isDarkMode ? "bg-orange-600/30 blur-[100px]" : "bg-orange-300/10",
      label: "E - GENIN"
    },
    'D': {
    ...
    'C': {
      ...
      glow: isDarkMode ? "bg-red-700/40 blur-[120px]" : "bg-red-300/5",
      label: "C - ANTIBREU"
    },
    'B': {
      ...
      glow: isDarkMode ? "bg-green-500/30 blur-[100px]" : "bg-green-300/5",
      label: "B - HUNTER"
    },
    'A': {
      ...
      glow: isDarkMode ? "bg-red-600/40 blur-[140px]" : "bg-red-200/5",
      label: "A - DOMÍNIO"
    },
    'S': {
      ...
      glow: isDarkMode ? "bg-white/20 blur-[150px]" : "bg-slate-200/10",
      label: "S - BANKAI"
    },
    'SS': {
      ...
      glow: isDarkMode ? "bg-blue-500/50 blur-[180px]" : "bg-blue-300/10",
      label: "SS - MONARCA"
    },
    'SSS': {
      ...
      glow: isDarkMode ? "bg-indigo-400/60 blur-[200px]" : "bg-indigo-200/20",
      label: "SSS - SUPREMO"
    }
  };
