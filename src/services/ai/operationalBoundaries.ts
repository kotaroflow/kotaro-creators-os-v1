...
export const ygnAgentContextGuards: Record<YgnOperationalContext, YgnAgentContextGuard> = {
  ...
  simulation_sandbox: {
    ...
    rules: [
      ...
      "Simulacao deve ser tratada como perfil fixo YGN Sandbox, nao como fragmento, cargo ou aba comum.",
    ...
    blockedActions: [
      ...
      "Carregar dois perfis reais ao mesmo tempo para representar simulacao.",
